...
| MindLynx-Aistock | Factors+Strategies+LLM | Daily/Real-time | Score + decision dashboard |
| mind_TradingAgent | Multi-agent debate (LangGraph) | Post-market | 5-tier rating |
...
**Upstream**: [Mindlx/lynx_vnpy](https://github.com/Mindlx/lynx_vnpy) ← [vnpy/vnpy](https://github.com/vnpy/vnpy) (MIT)
...
**Upstream**: [Mindlx/MindLynx-Aistock](https://github.com/Mindlx/MindLynx-Aistock) ← [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis) (MIT)
...
**Upstream**: [Mindlx/mind_TradingAgents](https://github.com/Mindlx/mind_TradingAgents) ← [TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents) (Apache 2.0)
...
| Subsystem (in systems/) | Upstream (Mindlx repos) | Original Upstream | License |
|------------------------|------------------------|-------------------|---------|
