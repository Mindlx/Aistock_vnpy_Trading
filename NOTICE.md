...
- **MindLynx-Aistock** — AI stock analysis framework (MIT License)
...
The fusion engine (`src/`, `scripts/`, `config/`) is original work released under the MIT License (see `LICENSE`).

> This project is for educational and research purposes only. No investment advice implied.
