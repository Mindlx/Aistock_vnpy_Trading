...
_TRADINGAGENTS_HOME = os.path.join(os.path.expanduser("~"), ".mind_tradingagent")
...
def _apply_env_overrides(config: dict) -> dict:
    """Apply MIND_TRADINGAGENT_* env vars to the config dict in-place."""
...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    "results_dir": os.getenv("MIND_TRADINGAGENT_RESULTS_DIR", os.path.join(_TRADINGAGENTS_HOME, "logs")),
    "data_cache_dir": os.getenv("MIND_TRADINGAGENT_CACHE_DIR", os.path.join(_TRADINGAGENTS_HOME, "cache")),
    "memory_log_path": os.getenv("MIND_TRADINGAGENT_MEMORY_LOG_PATH", os.path.join(_TRADINGAGENTS_HOME, "memory", "trading_memory.md")),
