...
from mind_tradingagent.dataflows.utils import safe_ticker_component
from mind_tradingagent.agents.utils.agent_states import (
    AgentState,
    InvestDebateState,
    RiskDebateState,
)
...
from mind_tradingagent.reporting import write_report_tree
...
class TradingAgentsGraph:
    ...
    def _log_state(self, trade_date, final_state):
        ...
        directory = Path(self.config["results_dir"]) / safe_ticker / "MindTradingAgentStrategy_logs"
