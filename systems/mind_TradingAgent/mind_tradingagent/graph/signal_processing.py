...
header (see :func:`mind_tradingagent.agents.schemas.render_pm_decision`).  The
deterministic heuristic in :mod:`mind_tradingagent.agents.utils.rating` is more
...
from mind_tradingagent.agents.utils.rating import parse_rating
