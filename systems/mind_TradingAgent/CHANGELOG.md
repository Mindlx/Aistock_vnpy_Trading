...
All notable changes to Mind TradingAgent are documented here.

## [1.0.0-dev] — 2026-05-29

### Rebrand

- **Forked from TauricResearch/TradingAgents v0.2.5**
- Renamed Python package from `tradingagents` to `mind_tradingagent`
- Renamed CLI entry point from `tradingagents` to `mind-tradingagent`
- Updated all imports, configs, and documentation accordingly
- Data directory changed from `~/.tradingagents/` to `~/.mind_tradingagent/`
- Project rebranded as **Mind TradingAgent** for private customization
