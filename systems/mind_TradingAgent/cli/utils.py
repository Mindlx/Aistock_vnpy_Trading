...
from mind_tradingagent.llm_clients.api_key_env import get_api_key_env
from mind_tradingagent.llm_clients.model_catalog import get_model_options
...
def ensure_api_key(provider: str) -> str | None:
    ...
    from mind_tradingagent.llm_clients.openai_client import OPENAI_COMPATIBLE_PROVIDERS
