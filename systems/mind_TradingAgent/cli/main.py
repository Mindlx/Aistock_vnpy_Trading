...
from mind_tradingagent.graph.analyst_execution import (
...
app = typer.Typer(
    name="mind-tradingagent",
    help="Mind TradingAgent CLI: 私有定制多智能体 LLM 金融交易框架 (源自 TradingAgents)",
...
def update_display(layout, spinner_text=None, stats_handler=None, start_time=None):
    ...
    layout["header"].update(
        Panel(
            "[bold green]Welcome to Mind TradingAgent CLI[/bold green]\n"
            "[dim]© Forked from [TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents)[/dim]",
            title="Welcome to Mind TradingAgent",
            border_style="green",
            padding=(1, 2),
            expand=True,
        )
...
def get_user_selections():
    ...
    welcome_content += "[bold green]Mind TradingAgent - 私有定制多智能体 LLM 金融交易框架[/bold green]\n\n"
    ...
    welcome_box = Panel(
        ...
        padding=(1, 2),
        title="Welcome to Mind TradingAgent",
        subtitle="源自 TradingAgents 的私有定制框架",
    )
...
def analyze(
    ...
    if clear_checkpoints:
        from mind_tradingagent.graph.checkpointer import clear_all_checkpoints
