...
header.  The deterministic heuristic in ``mind_tradingagent.agents.utils.rating``
...
from mind_tradingagent.agents.utils.rating import RATINGS_5_TIER, parse_rating
