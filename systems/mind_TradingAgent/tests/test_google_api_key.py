...
from mind_tradingagent.llm_clients.google_client import GoogleClient
...
class TestGoogleApiKeyStandardization(unittest.TestCase):
    ...
    @patch("mind_tradingagent.llm_clients.google_client.NormalizedChatGoogleGenerativeAI")
