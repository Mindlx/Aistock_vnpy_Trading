...
test('createDesktopBridge delegates update actions to ipcRenderer', async (t) => {
  ...
  assert.deepEqual(await desktopBridge.openReleasePage('https://github.com/Mindlx/blue-aistock/releases/tag/v3.13.0'), {
    channel: preloadModule.DESKTOP_OPEN_RELEASE_PAGE_CHANNEL,
    payload: 'https://github.com/Mindlx/blue-aistock/releases/tag/v3.13.0',
  });
