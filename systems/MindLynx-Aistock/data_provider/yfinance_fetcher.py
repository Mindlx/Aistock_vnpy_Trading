...
from .base import STANDARD_COLUMNS, BaseFetcher, DataFetchError, is_bse_code
...
class YfinanceFetcher(BaseFetcher):
    ...
    def _get_hk_main_indices(self, yf) -> list[dict[str, Any]] | None:
    ...
    def _get_us_stock_quote_from_stooq(self, stock_code: str) -> UnifiedRealtimeQuote | None:
        """
        ...
        request = Request(
            url,
            headers={
                "User-Agent": "Mozilla/5.0 (compatible; MindLynx-Aistock/1.0; +https://github.com/Mindlx/MindLynx-Aistock)",
        ...
        def _fetch_prev_close() -> float | None:
    ...
    def get_realtime_quote(self, stock_code: str) -> UnifiedRealtimeQuote | None:
        ...
        try:
            ...
            try:
                ...
                pe_ratio = ticker.info.get("trailingPE", None) or ticker.info.get("forwardPE", None)
