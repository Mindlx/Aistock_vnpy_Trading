...
def _to_longbridge_symbol(stock_code: str) -> str | None:
...
class LongbridgeFetcher(BaseFetcher):
    ...
    def _get_static_info(self, symbol: str) -> Any | None:
    ...
    def _compute_volume_ratio(self, symbol: str, today_volume: int) -> float | None:
    ...
    def get_realtime_quote(self, stock_code: str) -> UnifiedRealtimeQuote | None:
        ...
        logger.info(f"[Longbridge] {symbol} 行情获取成功: 价格={price}, 量比={volume_ratio}, 换手率={turnover_rate}")
        return quote
