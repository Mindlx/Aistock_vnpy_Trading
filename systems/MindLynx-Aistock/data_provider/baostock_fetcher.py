...
from .base import STANDARD_COLUMNS, BaseFetcher, DataFetchError, _is_hk_market, is_bse_code
...
class BaostockFetcher(BaseFetcher):
    ...
    def _fetch_raw_data(self, stock_code: str, start_date: str, end_date: str) -> pd.DataFrame:
        ...
        if is_bse_code(stock_code):
            raise DataFetchError(f"BaostockFetcher 不支持北交所 {stock_code}，将自动切换其他数据源")
