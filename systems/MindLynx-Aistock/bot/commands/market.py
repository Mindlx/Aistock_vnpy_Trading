...
class MarketCommand(BotCommand):
    ...
    def execute(self, message: BotMessage, args: list[str]) -> BotResponse:
        ...
        try:
            ...
            return BotResponse.error_response("大盘复盘启动失败，已释放运行锁；请稍后重试")
    ...
    def _release_market_review_lock(self, lock_token: Any | None) -> None:
        from src.core.market_review_lock import release_market_review_lock

        release_market_review_lock(lock_token)

    def _compute_market_review_override_region(self, config) -> str | None:
