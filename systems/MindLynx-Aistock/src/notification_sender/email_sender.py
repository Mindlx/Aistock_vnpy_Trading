...
class EmailSender:
    def __init__(self, config: Config):
        ...
        self._email_config = {
            ...
            "sender_name": getattr(config, "email_sender_name", "MindLynx-Aistock分析助手"),
    ...
    def _send_email_with_inline_image(self, image_bytes: bytes, receivers: list[str] | None = None) -> bool:
