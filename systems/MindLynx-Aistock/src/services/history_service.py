...
class HistoryService:
    ...
    def get_markdown_report(self, record_id: str) -> str | None:
        ...
        if not result:
            ...
            raise MarkdownReportGenerationError("Failed to rebuild AnalysisResult from raw_result", record_id=record_id)
    ...
    def _rebuild_analysis_result(self, raw_result: dict[str, Any], record) -> AnalysisResult | None:
        """
