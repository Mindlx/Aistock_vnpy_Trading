...
_FIELD_DEFINITIONS: dict[str, dict[str, Any]] = {
    "STOCK_LIST": {
        ...
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#环境变量完整列表",
            },
            {
                "label": "Tushare 股票列表指南",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/TUSHARE_STOCK_LIST_GUIDE.md",
            },
        ],
        "warning_codes": [],
    },
    ...
    "LITELLM_MODEL": {
        ...
        "docs": [
            {
                "label": "LLM 配置指南",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/LLM_CONFIG_GUIDE.md",
            },
            {
                "label": "完整指南：AI 模型配置",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#ai-模型配置",
            },
        ],
        ...
        "docs": [
            {
                ...
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/LLM_CONFIG_GUIDE.md#方式三litellm-原生-yaml-配置适合专家或复杂路由",
            },
        ],
    ...
    "LLM_CHANNELS": {
        ...
        "docs": [
            {
                "label": "LLM 配置指南：渠道模式",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/LLM_CONFIG_GUIDE.md#方式二渠道channels模式配置适合进阶多模型",
            },
            {
                "label": "LLM 服务商配置速查",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/llm-providers.md",
            },
        ],
    ...
    "REALTIME_SOURCE_PRIORITY": {
        ...
        "docs": [
            {
                "label": "完整指南：数据源配置",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#数据源配置",
            },
        ],
    ...
    "ANSPIRE_API_KEYS": {
        ...
        "docs": [
            {
                "label": "完整指南：搜索服务配置",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#搜索服务配置",
            },
        ],
    ...
    "WECHAT_WEBHOOK_URL": {
        ...
        "docs": [
            {
                "label": "完整指南：通知渠道配置",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#通知渠道详细配置",
            },
        ],
        ...
        "docs": [
            {
                ...
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#自定义-webhook",
            },
        ],
    ...
    "FEISHU_WEBHOOK_URL": {
        ...
        "docs": [
            {
                "label": "完整指南：飞书通知配置",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#飞书",
            },
            {
                "label": "飞书机器人配置专题",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/bot/feishu-bot-config.md",
            },
        ],
    ...
    "TELEGRAM_BOT_TOKEN": {
        ...
        "docs": [
            {
                "label": "完整指南：Telegram",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#telegram",
            },
        ],
        "warning_codes": ["secret_value"],
    },
    ...
    "EMAIL_SENDER": {
        ...
        "docs": [
            {
                "label": "完整指南：邮件",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#邮件",
            },
        ],
        "warning_codes": [],
    },
    ...
    "DISCORD_WEBHOOK_URL": {
        ...
        "docs": [
            {
                "label": "完整指南：Discord",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#discord",
            },
        ],
        "warning_codes": ["webhook_secret_value"],
    },
    ...
    "SCHEDULE_TIME": {
        ...
        "docs": [
            {
                "label": "完整指南：其他配置",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#其他配置",
            },
        ],
    ...
    "WEBUI_HOST": {
        ...
        "docs": [
            {
                "label": "云服务器访问 WebUI",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/deploy-webui-cloud.md",
            },
            {
                "label": "完整指南：WebUI 与 API",
                "href": "https://github.com/Mindlx/MindLynx-Aistock/blob/main/docs/full-guide.md#webui-与-api-服务",
            },
        ],
