...
_OPENAI_COMPATIBILITY_PAYLOAD_FIXTURES = [
    ...
    (
        "openai/cpa-compatible",
        {
            ...
            "usage": {"prompt_tokens": 2, "completion_tokens": 3, "total_tokens": 5, "prompt_cache_hit_tokens": 0, "prompt_cache_miss_tokens": 0},
        },
        "block response",
    ),
    ...
    (
        "openai/list-content-provider",
        {
            ...
            "usage": {"prompt_tokens": 3, "completion_tokens": 4, "total_tokens": 7, "prompt_cache_hit_tokens": 0, "prompt_cache_miss_tokens": 0},
        },
        "list response",
    ),
]
...
class TestAnalyzerGenerateText:
    ...
    def test_call_litellm_stream_aggregates_chunks_and_reports_progress(self):
        ...
        assert usage == {"prompt_tokens": 1, "completion_tokens": 2, "total_tokens": 3, "prompt_cache_hit_tokens": 0, "prompt_cache_miss_tokens": 0}
    ...
    def test_analyzer_legacy_router_recovery_cache_is_scoped_by_api_base(self, mock_router):
        ...
        assert all(
            item.get("litellm_params", {}).get("api_base") == "https://strict.example/v1" for item in strict_model_list
        )
        assert all(
            item.get("litellm_params", {}).get("api_base") == "https://flex.example/v1" for item in flex_model_list
        )
    ...
    def test_call_litellm_stream_falls_back_to_non_stream_before_first_chunk(self):
        ...
        assert model == "gemini/gemini-2.0-flash"
        assert usage == {"prompt_tokens": 4, "completion_tokens": 5, "total_tokens": 9, "prompt_cache_hit_tokens": 0, "prompt_cache_miss_tokens": 0}
    ...
    def test_call_litellm_normalizes_kimi_k26_temperature(self):
        ...
        assert usage == {"prompt_tokens": 1, "completion_tokens": 1, "total_tokens": 2, "prompt_cache_hit_tokens": 0, "prompt_cache_miss_tokens": 0}
    ...
    def test_call_litellm_recovers_from_temperature_default_error(self):
        ...
        def _dispatch(model, call_kwargs, **_kwargs):
            ...
            if len(calls) == 1:
                raise RuntimeError("temperature=0.2 is unsupported. Only the default (1.0) value is supported.")
            return response
    ...
    def test_analyze_integrity_retry_keeps_progress_monotonic(self):
        ...
        with (
            ...
            patch.object(
                ...
                "_call_litellm",
                side_effect=[
                    ("first response", "model-a", {"prompt_tokens": 1, "completion_tokens": 2, "total_tokens": 3, "prompt_cache_hit_tokens": 0, "prompt_cache_miss_tokens": 0}),
                    ("second response", "model-a", {"prompt_tokens": 1, "completion_tokens": 2, "total_tokens": 3, "prompt_cache_hit_tokens": 0, "prompt_cache_miss_tokens": 0}),
                ],
            ),
    ...
    def test_analyze_all_models_invalid_json_goes_through_post_processing(self):
        ...
        all_models_error = _AllModelsFailedError(
            ...
            last_usage={"prompt_tokens": 10, "completion_tokens": 20, "total_tokens": 30, "prompt_cache_hit_tokens": 0, "prompt_cache_miss_tokens": 0},
        )
        ...
        with (
            ...
            patch.object(analyzer, "_build_market_snapshot", return_value={}),
            patch.object(
                analyzer, "_check_content_integrity", return_value=(False, ["dashboard.core_conclusion.one_sentence"])
            ),
            patch.object(analyzer, "_build_integrity_retry_prompt", return_value="retry prompt"),
        ...
        assert usage_args[0][0] == {"prompt_tokens": 10, "completion_tokens": 20, "total_tokens": 30, "prompt_cache_hit_tokens": 0, "prompt_cache_miss_tokens": 0}
...
class TestMarketAnalyzerBypassFix:
    def _make_market_analyzer_with_mock_generate_text(self, return_value="复盘报告"):
        ...
        with patch("src.analyzer.get_config") as mock_cfg, patch("src.market_analyzer.get_config") as mock_cfg2:
            cfg = MagicMock()
            cfg.litellm_model = "gemini/gemini-2.0-flash"
            cfg.litellm_fallback_models = []
            cfg.gemini_api_keys = ["sk-gemini-testkey-1234"]
    ...
    def test_no_access_to_private_model_attribute(self):
        ...
        assert (
            not hasattr(ma.analyzer, "_model") or ma.analyzer._model is None
...
"""
    ...
    def test_no_private_attribute_access_in_market_analyzer_source(self):
        ...
        assert violations == [], f"market_analyzer.py still accesses private Analyzer attributes: {violations}"
