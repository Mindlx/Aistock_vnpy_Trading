        ...
        llm_model_list=[
            {
                ...
                "litellm_params": {"model": "gemini/gemini-2.0-flash", "api_key": "sk-test"},
            }
        ],
        ...
        channel_model_list = [
            {
                ...
                "litellm_params": {"api_key": "sk-chan", "api_base": "https://aihubmix.com/v1"},
            },
        ]
        cfg = _make_config(
        ...
        model_list = [
            {
                ...
                "litellm_params": {"model": "__legacy_deepseek__", "api_key": "sk-ds"},
            },
        ]
        cfg = _make_config(
...
class TestValidateStructuredNotification:
    ...
    def test_daily_digest_reserved_flag_warns_without_blocking(self):
        ...
        assert any(
            issue.field == "NOTIFICATION_DAILY_DIGEST_ENABLED" and issue.severity == "warning" for issue in issues
        )
