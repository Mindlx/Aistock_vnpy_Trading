...
class MarketReviewLocalizationTestCase(unittest.TestCase):
    ...
    def test_run_market_review_comma_joined_subset_cn_us(self) -> None:
        ...
        with (
            ...
            result = run_market_review(notifier, send_notification=False, override_region="cn,us")
    ...
    def test_run_market_review_comma_joined_subset_cn_hk(self) -> None:
        ...
        with (
            ...
            result = run_market_review(notifier, send_notification=False, override_region="cn,hk")
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                with db.get_session() as session:
                    row = session.query(AnalysisHistory).filter(AnalysisHistory.query_id == "market-task-001").first()
