...
class TestFundamentalContext(unittest.TestCase):
    ...
    def test_fundamental_context_derives_ttm_dividend_yield_from_quote_price(self) -> None:
        ...
        with (
            ...
            patch.object(
                manager, "get_capital_flow_context", return_value={"status": "not_supported", "source_chain": []}
            ),
            patch.object(
                manager, "get_dragon_tiger_context", return_value={"status": "not_supported", "source_chain": []}
            ),
