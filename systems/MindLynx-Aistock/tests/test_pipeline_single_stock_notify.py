...
class _TrackingNotifier:
    def __init__(self):
        ...
        self.generate_brief_report = MagicMock(side_effect=lambda results: "brief:" + ",".join(r.code for r in results))
        self.generate_single_stock_report = MagicMock(side_effect=lambda result: f"single:{result.code}")
