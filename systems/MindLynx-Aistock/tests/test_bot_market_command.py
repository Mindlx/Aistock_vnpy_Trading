...
class MarketCommandRegionFilterTestCase(unittest.TestCase):
    ...
    def test_both_with_cn_us_open_passes_override_region_cn_us(self) -> None:
        ...
        config, notifier, runtime_analyzer, runtime_search, market_review_module, runtime_module, _ = (
    ...
    def test_all_relevant_markets_closed_skips_review(self) -> None:
        ...
        message = _make_message()
        config, notifier, runtime_analyzer, runtime_search, market_review_module, runtime_module, notify_notifier = (
            self._patch_dependencies(
    ...
    def test_execute_releases_lock_when_thread_start_fails(self) -> None:
        ...
        with (
            patch.object(cmd, "_try_acquire_market_review_lock", return_value=lock_token),
