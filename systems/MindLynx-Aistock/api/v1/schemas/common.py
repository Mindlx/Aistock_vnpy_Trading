...
class RootResponse(BaseModel):
    ...
    version: str | None = Field(None, description="API 版本", example="1.0.0")

    class Config:
        json_schema_extra = {"example": {"message": "Daily Stock Analysis API is running", "version": "1.0.0"}}
...
class HealthResponse(BaseModel):
    ...
    class Config:
        json_schema_extra = {"example": {"status": "ok", "timestamp": "2024-01-01T12:00:00"}}
...
class ErrorResponse(BaseModel):
    ...
    class Config:
        json_schema_extra = {"example": {"error": "not_found", "message": "资源不存在", "detail": None}}
...
class SuccessResponse(BaseModel):
    ...
    class Config:
        json_schema_extra = {"example": {"success": True, "message": "操作成功", "data": None}}
