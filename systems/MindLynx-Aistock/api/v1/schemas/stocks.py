...
class StockQuote(BaseModel):
    ...
    prev_close: float | None = Field(None, description="昨收价")
...
class ExtractItem(BaseModel):
    ...
    code: str | None = Field(None, description="股票代码，None 表示解析失败")
    name: str | None = Field(None, description="股票名称（如有）")
...
class ExtractFromImageResponse(BaseModel):
    ...
    raw_text: str | None = Field(None, description="原始 LLM 响应（调试用）")
